...
public class Ukraine implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        try {
            ...
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM Ukraine");
            while (rs.next()) {
        ...
        Image iv1 = new  Image("file:../Project_final/Img/Land/2_bild.jpg");
