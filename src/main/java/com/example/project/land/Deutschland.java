...
public class Deutschland implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        try {
            ...
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM Deutschland");
            while (rs.next()) {
        ...
        Image iv1 = new  Image("file:../Project_final/Img/Land/1_bild.jpg");
