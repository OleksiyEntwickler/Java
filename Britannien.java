...
public class Britannien implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        try {
            ...
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM Grossbritanien");
            while (rs.next()) {
        ...
        Image iv1 = new  Image("file:../Project_final/Img/Land/4_bild.jpg");
